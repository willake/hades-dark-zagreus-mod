...
OnAnyLoad { "D_Boss01", function(triggerArgs)
    ...
    if ActiveEnemies ~= nil then
        ...
        for enemyId, enemy in pairs( ActiveEnemies ) do
            ...
            table.insert(enemy.WeaponOptions, "DarkArthurSword")
            EquipWeapon({ Name = "DarkArthurSword", DestinationId = enemy.ObjectId })
            table.insert(enemy.WeaponOptions, "DarkArthurSword2")
            EquipWeapon({ Name = "DarkArthurSword2", DestinationId = enemy.ObjectId })
