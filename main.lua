...
OnAnyLoad { "D_Boss01", function(triggerArgs)
    ...
    if ActiveEnemies ~= nil then
        ...
        for enemyId, enemy in pairs( ActiveEnemies ) do
            ...
            table.insert(enemy.WeaponOptions, "DarkPoseidonSword")
            EquipWeapon({ Name = "DarkPoseidonSword", DestinationId = enemy.ObjectId })
            table.insert(enemy.WeaponOptions, "DarkPoseidonSword2")
            EquipWeapon({ Name = "DarkPoseidonSword2", DestinationId = enemy.ObjectId })
            table.insert(enemy.WeaponOptions, "DarkPoseidonSword3")
            EquipWeapon({ Name = "DarkPoseidonSword3", DestinationId = enemy.ObjectId })
            table.insert(enemy.WeaponOptions, "DarkPoseidonSwordDash")
            EquipWeapon({ Name = "DarkPoseidonSwordDash", DestinationId = enemy.ObjectId })
            table.insert(enemy.WeaponOptions, "DarkPoseidonSwordParry")
            EquipWeapon({ Name = "DarkPoseidonSwordParry", DestinationId = enemy.ObjectId })
        end
    end
