...
OnAnyLoad { "D_Boss01", function(triggerArgs)
    ...
    if ActiveEnemies ~= nil then
        ...
        for enemyId, enemy in pairs( ActiveEnemies ) do
            ...
            table.insert(enemy.WeaponOptions, "DarkBow")
            EquipWeapon({ Name = "DarkBow", DestinationId = enemy.ObjectId })
            table.insert(enemy.WeaponOptions, "DarkBowSplitShot")
            EquipWeapon({ Name = "DarkBowSplitShot", DestinationId = enemy.ObjectId })
